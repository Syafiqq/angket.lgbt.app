...
<head>
    ...
    <link href="<?php echo base_url('/assets/css/auth/recover-counselor.min.css') ?>" rel="stylesheet">
    ...
    <form class="form-horizontal" role="form" id="recover" action="<?php echo site_url('auth/do_recover') ?>" method="post" style="margin-top: 40px">
        ...
        <div class="form-group">
            <div class="col-sm-6 text-left">
                <a href="<?php echo site_url('auth/recover?role=student') ?>" class="text-center new-account">Anda Siswa ?</a>
            </div>
